                    ...
                    <div className="mt-4 flex justify-between sm:space-y-6 sm:mt-0 sm:block sm:space-x-6">
                      <div className="flex items-center border-gray-100">
                        ...
                        <input
                          ...
                          min="1"
                          onChange={(e) => {
                            // You should update the product quantity in your state or localStorage
                            ...
                            // Optionally, trigger a state update to re-render
                            window.location.reload(); // for demo purposes; better to use state instead
                          }}
                        />
