                  ...
                  <div className="flex gap-x-8 h-96">
                    ...
                    <div className="flex-1 flex flex-col">
                      ...
                      <div className="space-y-3 text-sm">
                        <button
                          onClick={handleClick}
                          className="button w-full border cursor-pointer py-3 rounded-md bg-blue-600 text-white border-transparent hover:border-blue-600 hover:bg-transparent hover:text-black"
                        >
                          Add to bag
                        </button>
                        <button
                          onClick={() => window.location.reload()}
                          className="button w-full border cursor-pointer py-3 rounded-md bg-white text-blue-600 border-blue-600 hover:bg-blue-600 hover:border-blue-600 hover:text-white"
                        >
                          View full details
                        </button>
                      </div>
